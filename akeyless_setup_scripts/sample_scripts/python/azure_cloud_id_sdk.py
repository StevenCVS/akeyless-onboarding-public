...
class AkeylessConnection:
    ...
    def akeyless_auth(self):
        ...
        self.cloud_id = cloud_id_generator.generateAzure()

        # Payload to auth to Akeyless using Azure Cloud ID
        auth_body = akeyless.Auth(access_type="azure_ad", access_id=self.access_id, cloud_id=self.cloud_id)
