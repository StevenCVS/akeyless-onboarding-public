...
class AkeylessConnection:
    ...
    def akeyless_auth(self):
        ...
        self.cloud_id = cloud_id_generator.generateGcp(audience="cvs.akeyless.io")

        # Payload to auth to Akeyless using GCP Cloud ID
        auth_body = akeyless.Auth(access_type="gcp", access_id=self.access_id, cloud_id=self.cloud_id)
